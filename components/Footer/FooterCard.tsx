...
const FooterCard = () => {
  return (
    <div className="relative bg-white h-[600px] mt-28 rounded-t-3xl flex flex-col justify-between ">
      ...
      <div className="flex justify-between  text-gray-500 p-6">
        <div className="w-1/4 space-y-5">
          <div className="text-black text-xl">
            <span>logo </span>Cassy
          </div>
          <p className="text-sm">
      ...
      {/* footer */}
      <div className="flex justify-between text-sm p-6 mb-5 border-t border-t-gray-300 text-gray-600">
        <div>
